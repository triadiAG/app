...
function redirectSSOPage() {
  window.location.href = baseUserUrl+'/auth?response_type=code&client_id=user&redirect_uri=http://localhost:8001/callback.php';
}
...
function requestSSO(code) {
  ...
  var params = 'grant_type=authorization_code&client_id=user&client_secret=IaoAGr1VDVSCxxFlzoXtZpIZbpMfFBZL&code='+code+'&redirect_uri=http://localhost:8001/callback.php';
